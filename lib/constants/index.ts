...
export const GOAPI_ENDPOINT = 'https://api-dsa.17app.co';
export const GOAPI_ENDPOINT_STA = 'https://sta-api.17app.co';
export const GOAPI_ENDPOINT_UAT = 'https://uat-api.17app.co';

export const EVENT_SERVER_ENDPOINT = 'https://event-server.17app.co';
export const EVENT_SERVER_ENDPOINT_STA = 'https://event-server-sta.17app.co';
export const EVENT_SERVER_ENDPOINT_UAT = 'https://event-server-uat.17app.co';
