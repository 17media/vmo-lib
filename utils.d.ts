...
export declare const getEventoryFireantUrl: () => "https://fireant.17app.co/api/v1/eventory" | "https://stag-fireant.17app.co/api/v1/eventory" | "https://uat-fireant.17app.co/api/v1/eventory";
export declare const getOfficial17LiveUrl: () => "https://17.live" | "https://sta.17.live" | "https://uat.17.live";
