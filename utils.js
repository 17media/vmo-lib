import { EVENTORY_FIREANT_ENDPOINT, EVENTORY_FIREANT_ENDPOINT_STA, EVENTORY_FIREANT_ENDPOINT_UAT, GOAPI_ENDPOINT, GOAPI_ENDPOINT_STA, GOAPI_ENDPOINT_UAT, MAIN_HOST, MAIN_HOST_CN, MAIN_HOST_STA, MAIN_HOST_STA_CN, MAIN_HOST_UAT, MAIN_HOST_UAT_CN, OFFICIAL_17LIVE_HOST, OFFICIAL_17LIVE_HOST_STA, OFFICIAL_17LIVE_HOST_UAT, } from './constants';
...
export const getEventoryFireantUrl = () => {
    if (isProdVmo17Media())
        return EVENTORY_FIREANT_ENDPOINT;
    if (isStagVmo17Media())
        return EVENTORY_FIREANT_ENDPOINT_STA;
    if (isUatVmo17Media())
...
export const getOfficial17LiveUrl = () => {
    if (isProdVmo17Media())
        return OFFICIAL_17LIVE_HOST;
    if (isStagVmo17Media())
        return OFFICIAL_17LIVE_HOST_STA;
    if (isUatVmo17Media())
