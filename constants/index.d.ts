...
export declare const GOAPI_ENDPOINT = "https://api-dsa.17app.co/api";
export declare const GOAPI_ENDPOINT_STA = "https://sta-api.17app.co/api";
export declare const GOAPI_ENDPOINT_UAT = "https://uat-api.17app.co/api";
...
export declare const EVENTORY_FIREANT_ENDPOINT = "https://fireant.17app.co/api/v1/eventory";
export declare const EVENTORY_FIREANT_ENDPOINT_STA = "https://stag-fireant.17app.co/api/v1/eventory";
export declare const EVENTORY_FIREANT_ENDPOINT_UAT = "https://uat-fireant.17app.co/api/v1/eventory";
export declare const OFFICIAL_17LIVE_HOST = "https://17.live";
export declare const OFFICIAL_17LIVE_HOST_STA = "https://sta.17.live";
export declare const OFFICIAL_17LIVE_HOST_UAT = "https://uat.17.live";
/**
 * GCP bucket
 */
