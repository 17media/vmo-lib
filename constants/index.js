...
export const EVENT_SERVER_ENDPOINT_STA = 'https://event-server-sta.17app.co/api';
export const EVENT_SERVER_ENDPOINT_UAT = 'https://event-server-uat.17app.co/api';
export const EVENTORY_FIREANT_ENDPOINT = 'https://fireant.17app.co/api/v1/eventory';
export const EVENTORY_FIREANT_ENDPOINT_STA = 'https://stag-fireant.17app.co/api/v1/eventory';
export const EVENTORY_FIREANT_ENDPOINT_UAT = 'https://uat-fireant.17app.co/api/v1/eventory';
 ...
 */
export const EVENTORY_ENDPOINT = 'https://api.17app.co/api/v1/leaderboards/eventory';
/**
 * same as const `EVENTORY_ENDPOINT`.
 */
export const EVENTORY_OFFLINE_ENDPOINT = 'https://dsa-api.17app.co/api/v1/leaderboards/eventory';
/**
 * iframe domain
 *
...
export const ASSETS_CND_ENDPOINT = 'https://storage.googleapis.com/media17-prod-web-assets/campaign';
/**
 * Avatar CDN
 */
 ...
 */
export const SENTRY_DSN_URL = 'https://8526f3bd6d3a4abcac1b3fdcbc06b416@o998499.ingest.sentry.io/6547346';
