 ...
 */
export declare const getParsedURL: ({ apiEndpoint, type, limit, cursor, withoutOnliveInfo, allBoards, env, }: Omit<Params, "cancelToken" | "callback" | "preData"> & {
    apiEndpoint: string;
} & {
    env?: Env | undefined;
}) => string;
export declare const getLeaderboardEventory: ({ type, cancelToken, limit, cursor, withoutOnliveInfo, allBoards, strategy, env, }: Params & {
